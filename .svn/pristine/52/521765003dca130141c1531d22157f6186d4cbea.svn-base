                ...
                <div class="base-info-form">
                  <el-form ref="personalParams" :rules="rules" :model="personalParams" label-width="140px">
                    <el-form-item label="申请类型">
                      <el-radio label="个人额度" v-model="usertype"></el-radio>
                    </el-form-item>
                    <el-form-item label="姓名" class="short-input" prop="name">
                      <el-input type="text" v-model="personalParams.name" :disabled="true"></el-input>
                    </el-form-item>
                    <el-form-item label="证件类型" class="short-input" prop="cardType">
                      <el-select v-model="personalParams.cardType" disabled>
                    ...
                    <el-form-item label="证件号码" prop="cardNum">
                      <el-input type="text" v-model="personalParams.cardNum" :disabled="true"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="手机号码" prop="phoneNum">
                      <el-input type="text" v-model="personalParams.phoneNum" :disabled="true"></el-input>
                    </el-form-item>
                  </el-form>
                </div>
              </div>
  ...
  methods: {
    ...
    getAuthInfo() {
      api.getAuthInfo().then(res => {
        this.idCardForward.accessPath = res.authPersonal.legalFileFrontUrl
        this.idCardBack.accessPath = res.authPersonal.legalFileVersoUrl
        this.personalParams.name = res.authPersonal.userName
        this.personalParams.cardNum = res.authPersonal.certificateNumber
        this.personalParams.phoneNum = res.authPersonal.telephone
        this.personalParams.idCardForward = res.authPersonal.legalFrontFileId
        this.personalParams.idCardBack = res.authPersonal.legalVersoFileId
      })
    }
  },
  mounted() {
