    ...
    <div class="authentication_message">
      ...
      <el-form label-position="top" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        <el-form-item label="当前密码" prop="beforPassword">
          <el-input v-if="!eyeWatch[0]" class="list" type="password" placeholder="请输入当前密码" v-model="ruleForm.beforPassword" @focus="focusClick"></el-input>
          <el-input v-if="eyeWatch[0]" class="list" type="text" placeholder="请输入当前密码" v-model="ruleForm.beforPassword" @focus="focusClick"></el-input>
          <!-- 眼睛 -->
        ...
        <el-form-item label="新 密 码" prop="newPassword">
          <el-input v-if="!eyeWatch[1]" class="list" type="password" placeholder="请输入新密码" v-model="ruleForm.newPassword" @focus="focusClick"></el-input>
          <el-input v-if="eyeWatch[1]" class="list" type="text" placeholder="请输入新密码" v-model="ruleForm.newPassword" @focus="focusClick"></el-input>
          <!-- 眼睛 -->
      ...
      rules: {
        beforPassword: [
          { required: true, message: "请输入您的密码", trigger: "blur" },
          {
            ...
            message: "请输入6-12位字母或数字,暂不支持特殊标点符号和中文"
          }
        ],
        newPassword: [
